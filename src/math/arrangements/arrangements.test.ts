...
import { nCr, nPr } from "./arrangements"
...
describe("combinations and permutations function", () => {
  describe("nCr function", () => {
    ...
    it("should handle NaN values correctly", () => {
      expect(() => nCr(5, NaN)).toThrow("n and r must be integers.")
      expect(() => nCr(NaN, 3)).toThrow("n and r must be integers.")
    })

    it("should handle Infinity values correctly", () => {
      expect(() => nCr(5, Infinity)).toThrow("n and r must be integers.")
      expect(() => nCr(Infinity, 3)).toThrow("n and r must be integers.")
    })
  ...
  describe("nPr function", () => {
    ...
    it("should handle NaN values correctly", () => {
      expect(() => nPr(5, NaN)).toThrow("n and r must be integers.")
      expect(() => nPr(NaN, 3)).toThrow("n and r must be integers.")
    })

    it("should handle Infinity values correctly", () => {
      expect(() => nPr(5, Infinity)).toThrow("n and r must be integers.")
      expect(() => nPr(Infinity, 3)).toThrow("n and r must be integers.")
    })
